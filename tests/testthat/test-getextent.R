context("Checking extraction of extent")
testthat::test_that("Test retrieval of extent",{
  ...
  in_rast_file <- system.file("extdata", "sprawl_EVItest.tif", package = "sprawl.data")
  ...
  in_vect_file <- system.file("extdata","lc_polys.shp", package = "sprawl.data")
