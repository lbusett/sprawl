...
# in_raster_file = 'D:/Documents/ERMES/Documents/Study Areas/WA/GM/Examples/MOD15A2_A2015289_euroafrica_LAI'
...
# in_ermes_grid_laea  = 'D:/Documents/ERMES/Documents/Study Areas/WA/GM/gm_2km_grid_sinu_ok.shp'
# out_folder = 'D:/Documents/ERMES/Documents/Data_Processing/EO_Data_Aggregation/GM/MOD'
# out_filename = 'D:/Documents/ERMES/Documents/Data_Processing/EO_Data_Aggregation/GM/MOD_test'
# out_format = 'GTiff'
# fc_threshold = 0.75
...
laea_crs = CRS('+proj=sinu +lon_0=0 +x_0=0 +y_0=0 +a=6371007.181 +b=6371007.181 +units=m +no_defs')
...
gdalwarp(in_raster_file,out_file_raster, s_srs = raster_orig_crs, t_srs = raster_orig_crs,
